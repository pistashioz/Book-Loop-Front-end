...
<script setup>
import { ref } from 'vue';
import { createGenre } from '~/composables/api/adminService'; 
...
const submitForm = async () => {
    try {
        const response = await createGenre(genreName.value)
