<template>
    <div class="flex flex-col items-center space-y-4">
      <section id="profile-section" class="flex w-full laptop:w-5/12 border rounded-lg p-4 items-start gap-x-8">
        <!-- Avatar Section -->
        ...
        <div id="right-wrapper" class="flex h-36 flex-col flex-grow gap-y-2">
          ...
          <header id="first-wrapper" class="flex justify-between items-center">
            <div id="user-n-reviews">
              <h1 class="text-base font-bold dark:text-white">Username</h1>
          ...
          <section id="second-wrapper" class="flex justify-between items-end">
            <div id="about" class="flex flex-col items-start">
              ...
              <div id="following" class="flex items-end gap-x-2 mt-2">
                ...
                <p class="text-xs font-satoshi-medium text-gray-900 dark:text-white">123 followers, following 34</p>
              </div>
            </div>
            <div class="flex items-center gap-x-2">
              <label for="deliver-toggle" class="text-xs font-satoshi-medium text-gray-700 dark:text-white">Deliver by hand?</label>
              <input type="checkbox" id="deliver-toggle" value="" class="sr-only peer" checked disabled>
      ...
      <section id="main-container" class="flex flex-col w-full laptop:w-5/12 items-start">
        <ul class="flex flex-wrap w-full text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
          <li class="me-2">
            <a href="#" aria-current="page" class="inline-block p-4 text-blue-600 bg-gray-100 rounded-t-lg active dark:bg-gray-800 dark:text-blue-500">Listings</a>
          </li>
          <li class="me-2">
            <a href="#" class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover:text-gray-300">Purchase Reviews</a>
          </li>
          <li class="me-2">
            <a href="#" class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover:text-gray-300">Literary Reviews</a>
          </li>
        </ul>
        <div id="content-holder" class="flex flex-col flex-grow border border-t-0 w-full overflow-auto">
  ...
  <style scoped>
  /* Ensure that the right wrapper fills the height of the avatar */
  #profile-section {
    display: flex;
