        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="p-4 md:p-5">
            <ul class="space-y-4 mb-4">
              <li v-for="following in following" :key="following.userId">
                <div class="flex items-center space-x-4">
                  <img :src="following.profileImage" alt="Profile Image" class="w-10 h-10 rounded-full">
                  <div>
                    <h4 class="text-sm font-medium text-gray-900 dark:text-white">{{ following.username }}</h4>
                  </div>
                </div>
              </li>
            </ul>
